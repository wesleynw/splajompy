...
type Querier interface {
	...
	GetAllPostIdsCursor(ctx context.Context, arg GetAllPostIdsCursorParams) ([]int32, error)
	...
	GetPostIdsByFollowingCursor(ctx context.Context, arg GetPostIdsByFollowingCursorParams) ([]int32, error)
	GetPostIdsByUserIdCursor(ctx context.Context, arg GetPostIdsByUserIdCursorParams) ([]int32, error)

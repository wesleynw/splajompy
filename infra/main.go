...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		base64CloudfrontKey := config.GetSecret("cloudfrontSigningPubkey")
		pemStr := base64CloudfrontKey.ApplyT(func(key string) (string, error) {
					...
					&digitalocean.AppSpecServiceArgs{
						...
						Envs: digitalocean.AppSpecServiceEnvArray{
							...
							&digitalocean.AppSpecServiceEnvArgs{
								...
								Value: config.GetSecret("cloudfrontSigningPrivkey"),
							},
							&digitalocean.AppSpecServiceEnvArgs{
